 ...
 * - MedicoStudyTimetableInput - The input type for the createStudyTimetable function.
 * - MedicoStudyTimetableOutput - The return type for the createStudyTimetable function.
 */
