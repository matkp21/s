...
(function (global, factory) {
  ...
  const AlignCenterHorizontal = createLucideIcon("align-center-horizontal", __iconNode$oe);
  ...
  const AlignCenterVertical = createLucideIcon("align-center-vertical", __iconNode$od);
  ...
  const AlignCenter = createLucideIcon("align-center", __iconNode$oc);
  ...
  const __iconNode$nu = [["path", { d: "M6 9h6V5l7 7-7 7v-4H6V9z", key: "7fvt9c" }]];
  const ArrowBigRight = createLucideIcon("arrow-big-right", __iconNode$nu);

  const __iconNode$nt = [
    ["path", { d: "M9 19h6", key: "456am0" }],
    ["path", { d: "M9 15v-3H5l7-7 7 7h-4v3H9z", key: "1r2uve" }]
  ];
  const ArrowBigUpDash = createLucideIcon("arrow-big-up-dash", __iconNode$nt);
  ...
  const ArrowLeftFromLine = createLucideIcon("arrow-left-from-line", __iconNode$ne);
  ...
  const ArrowLeftRight = createLucideIcon("arrow-left-right", __iconNode$nd);
  ...
  const ArrowLeftToLine = createLucideIcon("arrow-left-to-line", __iconNode$nc);

  const __iconNode$nb = [
    ["path", { d: "m12 19-7-7 7-7", key: "1l729n" }],
    ["path", { d: "M19 12H5", key: "x3x0zl" }]
  ];
  const ArrowLeft = createLucideIcon("arrow-left", __iconNode$nb);
  ...
  const BadgeAlert = createLucideIcon("badge-alert", __iconNode$mJ);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$mD);
  ...
  const BadgeJapaneseYen = createLucideIcon("badge-japanese-yen", __iconNode$mC);
  ...
  const BadgeMinus = createLucideIcon("badge-minus", __iconNode$mB);
  ...
  const BadgePercent = createLucideIcon("badge-percent", __iconNode$mA);
  ...
  const BadgePlus = createLucideIcon("badge-plus", __iconNode$mz);
  ...
  const BadgePoundSterling = createLucideIcon("badge-pound-sterling", __iconNode$my);
  ...
  const BanknoteArrowUp = createLucideIcon("banknote-arrow-up", __iconNode$mn);
  ...
  const BatteryLow = createLucideIcon("battery-low", __iconNode$me);
  ...
  const BatteryWarning = createLucideIcon("battery-warning", __iconNode$md);

  const __iconNode$mc = [
    ["rect", { width: "16", height: "10", x: "2", y: "7", rx: "2", ry: "2", key: "1w10f2" }],
    ["line", { x1: "22", x2: "22", y1: "11", y2: "13", key: "4dh1rd" }]
  ];
  const Battery = createLucideIcon("battery", __iconNode$mc);
  ...
  const Beaker = createLucideIcon("beaker", __iconNode$mb);
  ...
  const Bean = createLucideIcon("bean", __iconNode$m9);
  ...
  const BedDouble = createLucideIcon("bed-double", __iconNode$m8);
  ...
  const BedSingle = createLucideIcon("bed-single", __iconNode$m7);
  ...
  const Bed = createLucideIcon("bed", __iconNode$m6);
  ...
  const Beef = createLucideIcon("beef", __iconNode$m5);
  ...
  const BeerOff = createLucideIcon("beer-off", __iconNode$m4);
  ...
  const BookText = createLucideIcon("book-text", __iconNode$lk);
  ...
  const BookType = createLucideIcon("book-type", __iconNode$lj);
  ...
  const BookmarkMinus = createLucideIcon("bookmark-minus", __iconNode$lc);
  ...
  const Boxes = createLucideIcon("boxes", __iconNode$l3);
  ...
  const Braces = createLucideIcon("braces", __iconNode$l2);
  ...
  const Briefcase = createLucideIcon("briefcase", __iconNode$kV);
  ...
  const Calendar1 = createLucideIcon("calendar-1", __iconNode$kG);
  ...
  const CalendarArrowDown = createLucideIcon("calendar-arrow-down", __iconNode$kF);
  ...
  const CalendarClock = createLucideIcon("calendar-clock", __iconNode$kB);
  ...
  const CalendarCog = createLucideIcon("calendar-cog", __iconNode$kA);
  ...
  const CalendarDays = createLucideIcon("calendar-days", __iconNode$kz);
  ...
  const CaseSensitive = createLucideIcon("case-sensitive", __iconNode$k7);
  ...
  const CaseUpper = createLucideIcon("case-upper", __iconNode$k6);
  ...
  const ChartBar = createLucideIcon("chart-bar", __iconNode$jW);
  ...
  const ChartColumnBig = createLucideIcon("chart-column-big", __iconNode$jV);
  ...
  const ChartColumnDecreasing = createLucideIcon("chart-column-decreasing", __iconNode$jU);
  ...
  const __iconNode$jw = [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]];
  const ChevronUp = createLucideIcon("chevron-up", __iconNode$jw);

  const __iconNode$jv = [
    ["path", { d: "m7 20 5-5 5 5", key: "13a0gw" }],
    ["path", { d: "m7 4 5 5 5-5", key: "1kwcof" }]
  ];
  const ChevronsDownUp = createLucideIcon("chevrons-down-up", __iconNode$jv);
  ...
  const CircleChevronUp = createLucideIcon("circle-chevron-up", __iconNode$j4);
  ...
  const CircleDashed = createLucideIcon("circle-dashed", __iconNode$j3);
  ...
  const CircleDivide = createLucideIcon("circle-divide", __iconNode$j2);
  ...
  const CirclePause = createLucideIcon("circle-pause", __iconNode$iQ);
  ...
  const CirclePercent = createLucideIcon("circle-percent", __iconNode$iP);
  ...
  const CircleUser = createLucideIcon("circle-user", __iconNode$iG);
  ...
  const CircleX = createLucideIcon("circle-x", __iconNode$iF);
  ...
  const Clock7 = createLucideIcon("clock-7", __iconNode$ig);

  const __iconNode$if = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 8 14", key: "tmc9b4" }]
  ];
  const Clock8 = createLucideIcon("clock-8", __iconNode$if);
  ...
  const CloudSunRain = createLucideIcon("cloud-sun-rain", __iconNode$hW);
  ...
  const Compass = createLucideIcon("compass", __iconNode$hE);
  ...
  const Component = createLucideIcon("component", __iconNode$hD);
  ...
  const Computer = createLucideIcon("computer", __iconNode$hC);
  ...
  const Cross = createLucideIcon("cross", __iconNode$h7);
  ...
  const Crosshair = createLucideIcon("crosshair", __iconNode$h6);
  ...
  const Crown = createLucideIcon("crown", __iconNode$h5);
  ...
  const Diamond = createLucideIcon("diamond", __iconNode$gS);

  const __iconNode$gR = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2", key: "1m3agn" }],
    ["path", { d: "M12 12h.01", key: "1mp3jc" }]
  ];
  const Dice1 = createLucideIcon("dice-1", __iconNode$gR);
  ...
  const Disc2 = createLucideIcon("disc-2", __iconNode$gI);
  ...
  const Drum = createLucideIcon("drum", __iconNode$gn);
  ...
  const Drumstick = createLucideIcon("drumstick", __iconNode$gl);
  ...
  const Ear = createLucideIcon("ear", __iconNode$gj);
  ...
  const EarthLock = createLucideIcon("earth-lock", __iconNode$gi);
  ...
  const Feather = createLucideIcon("feather", __iconNode$fX);
  ...
  const Fence = createLucideIcon("fence", __iconNode$fW);
  ...
  const FileCheck = createLucideIcon("file-check", __iconNode$fH);
  ...
  const FileClock = createLucideIcon("file-clock", __iconNode$fG);
  ...
  const FileLock2 = createLucideIcon("file-lock-2", __iconNode$fs);
  ...
  const FileX = createLucideIcon("file-x", __iconNode$eZ);
  ...
  const Fish = createLucideIcon("fish", __iconNode$eS);
  ...
  const FlagOff = createLucideIcon("flag-off", __iconNode$eR);
  ...
  const FlipHorizontal2 = createLucideIcon("flip-horizontal-2", __iconNode$eG);
  ...
  const FlipHorizontal = createLucideIcon("flip-horizontal", __iconNode$eF);
  ...
  const Heater = createLucideIcon("heater", __iconNode$cF);
  ...
  const Hexagon = createLucideIcon("hexagon", __iconNode$cE);

  const __iconNode$cD = [
    ["path", { d: "m9 11-6 6v3h9l3-3", key: "1a3l36" }],
    ["path", { d: "m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4", key: "14a9rk" }]
  ];
  const Highlighter = createLucideIcon("highlighter", __iconNode$cD);
  ...
  const History = createLucideIcon("history", __iconNode$cC);
  ...
  const HouseWifi = createLucideIcon("house-wifi", __iconNode$cu);
  ...
  const LampWallDown = createLucideIcon("lamp-wall-down", __iconNode$bU);
  ...
  const LampWallUp = createLucideIcon("lamp-wall-up", __iconNode$bT);
  ...
  const Lamp = createLucideIcon("lamp", __iconNode$bS);
  ...
  const ListTree = createLucideIcon("list-tree", __iconNode$b7);
  ...
  const Loader = createLucideIcon("loader", __iconNode$b3);
  ...
  const LocateFixed = createLucideIcon("locate-fixed", __iconNode$b2);
  ...
  const MailWarning = createLucideIcon("mail-warning", __iconNode$aL);
  ...
  const MailX = createLucideIcon("mail-x", __iconNode$aK);

  const __iconNode$aJ = [
    ["rect", { width: "20", height: "16", x: "2", y: "4", rx: "2", key: "18n3k1" }],
    ["path", { d: "m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7", key: "1ocrg3" }]
  ];
  const Mail = createLucideIcon("mail", __iconNode$aJ);
  ...
  const MessageSquareCode = createLucideIcon("message-square-code", __iconNode$a5);
  ...
  const MessageSquareDashed = createLucideIcon("message-square-dashed", __iconNode$a4);
  ...
  const Music4 = createLucideIcon("music-4", __iconNode$91);
  ...
  const Music = createLucideIcon("music", __iconNode$90);
  ...
  const Network = createLucideIcon("network", __iconNode$8X);
  ...
  const NutOff = createLucideIcon("nut-off", __iconNode$8N);
  ...
  const Nut = createLucideIcon("nut", __iconNode$8M);
  ...
  const PanelTopOpen = createLucideIcon("panel-top-open", __iconNode$8b);

  const __iconNode$8a = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M3 9h18", key: "1pudct" }]
  ];
  const PanelTop = createLucideIcon("panel-top", __iconNode$8a);
  ...
  const PartyPopper = createLucideIcon("party-popper", __iconNode$83);
  ...
  const RefreshCcw = createLucideIcon("refresh-ccw", __iconNode$6B);
  ...
  const RotateCcwSquare = createLucideIcon("rotate-ccw-square", __iconNode$6j);
  ...
  const RotateCwSquare = createLucideIcon("rotate-cw-square", __iconNode$6h);
  ...
  const Rows3 = createLucideIcon("rows-3", __iconNode$6b);
  ...
  const Scaling = createLucideIcon("scaling", __iconNode$5X);
  ...
  const Ship = createLucideIcon("ship", __iconNode$57);
  ...
  const SignalLow = createLucideIcon("signal-low", __iconNode$4W);
  ...
  const Snail = createLucideIcon("snail", __iconNode$4B);
  ...
  const TrainTrack = createLucideIcon("train-track", __iconNode$1T);
  ...
  const TriangleAlert = createLucideIcon("triangle-alert", __iconNode$1I);

  const __iconNode$1H = [
    ["polyline", { points: "22 7 13.5 15.5 8.5 10.5 2 17", key: "126l90" }],
    ["polyline", { points: "16 7 22 7 22 13", key: "kwv8wd" }]
  ];
  const TrendingUp = createLucideIcon("trending-up", __iconNode$1H);
