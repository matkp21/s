...
import { Loader2, BookOpen, Wand2, FileText } from 'lucide-react';
...
type StudyNotesFormValues = z.infer<typeof StudyNotesGeneratorInputSchema>;
...
export function StudyNotesGenerator({ initialTopic }: StudyNotesGeneratorProps) {
  ...
  const form = useForm<StudyNotesFormValues>({
    resolver: zodResolver(StudyNotesGeneratorInputSchema),
    defaultValues: {
      topic: initialTopic || "",
