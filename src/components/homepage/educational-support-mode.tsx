        ...
        <Card className="shadow-md rounded-xl h-full flex flex-col">
          ...
          <CardFooter>
            <Button asChild className="w-full rounded-lg">
                <Link href={`/medico?tool=${dailyTopic.toolId}&topic=${encodeURIComponent(dailyTopic.prefilledTopic)}`}>Learn More <ArrowRight className="ml-2 h-4 w-4"/></Link>
            </Button>
          </CardFooter>
        </Card>
      </motion.div>
        ...
        <Card className="shadow-md rounded-xl h-full flex flex-col">
          ...
          <CardFooter>
            <Button asChild variant="secondary" className="w-full rounded-lg">
                <Link href={`/medico/library`}>Go to Knowledge Hub <ArrowRight className="ml-2 h-4 w-4"/></Link>
            </Button>
          </CardFooter>
        </Card>
      </motion.div>
