...
interface NotificationPanelCompactProps {
  ...
  hasUnreadNotifications: boolean; // Though not directly used in this component's render logic anymore
  onClose: () => void;
  onMarkAllAsRead: () => void;
  onMarkAsRead: (id: string) => void; // To pass to individual cards
  onViewAllNotifications: () => void;
  className?: string; // For conditional animated border
}
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        className // Conditional class for animated border
      )}
      aria-modal="true"
      role="dialog"
