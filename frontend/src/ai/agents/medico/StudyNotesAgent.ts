...
1.  **'notes' field**: Generate comprehensive notes on the topic.
2.  **'summaryPoints' field**: Create 3-5 key, high-yield summary points.
3.  **'diagram' field**: Generate Mermaid.js syntax for a flowchart.
