...
export default function ProfilePage() {
  ...
  if (!isClient) {
    return (
      <>
        <h1 className="text-3xl font-bold tracking-tight text-foreground my-4">Loading Profile...</h1>
  ...
  return (
    <>
      <h1 className="text-3xl font-bold tracking-tight text-foreground my-4">My Profile</h1>
