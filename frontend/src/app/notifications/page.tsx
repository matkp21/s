...
export default function NotificationsPage({ 
  ...
  if (!isClient && !initialNotifications) { // Show loading only if client and no initial props
    return (
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold tracking-tight text-foreground my-4">Loading Notifications...</h1>
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
      <h1 className="text-3xl font-bold tracking-tight text-foreground my-4">Notifications</h1>
