  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="input-focus-glow rounded-lg">
              <FormLabel htmlFor="guideline-query-input">Medical Topic or Condition</FormLabel>
        ...
        />
        <Button type="submit" className="w-full rounded-lg py-3 text-base group" disabled={isPending}>
          {isPending ? (
            <>
